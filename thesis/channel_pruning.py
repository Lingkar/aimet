...
# imports required for channel pruning
...
auto_params = ChannelPruningParameters.AutoModeParams(greed_params,
                                                      modules_to_ignore=[model.conv1])
channel_pruning_params = ChannelPruningParameters(mode=ChannelPruningParameters.Mode.auto,
                                                  params=auto_params,
...
print(comp_model)
print(stats)
torch.save(comp_model, './models/compressedBeeAnts/cp_model_1')

torch.onnx.export(comp_model, torch.rand(input_shape).cuda(), './models/compressedBeeAnts/cp_model_1.onnx')
OnnxSaver.set_node_names('./models/compressedBeeAnts/cp_model_1.onnx', comp_model, torch.rand(input_shape))
